...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/AppVftq003.vue?vue&type=template&id=3907f223
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, null, [_hoisted_1, (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_2, [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_PageHeader, {
    ...
    labels: $setup.labels,
    dataCategory: $setup.dataCategory,
    onDataRefered: $options.dataRefered,
    referDialog: "false",
    canResend: "true"
  }, null, 8, ["labels", "dataCategory", "onDataRefered"])])), ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(runtime_core_esm_bundler/* Teleport */.Im, {
    to: "#referdialog"
  }, [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_EntryForm, {
    ref: "referForm",
    labels: $setup.labels,
    ...
    referDialog: "true",
    canResend: "false"
  }, null, 8, ["labels", "dataCategory", "onDataRefered"])]))], 64);
}
;// CONCATENATED MODULE: ./src/AppVftq003.vue?vue&type=template&id=3907f223
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/SearchForm.vue?vue&type=template&id=30527109

const SearchFormvue_type_template_id_30527109_hoisted_1 = {
  id: "searchpanel",
  class: "panel-body search-panel"
};
const SearchFormvue_type_template_id_30527109_hoisted_2 = {
...
const _hoisted_6 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", {
  class: "required"
}, "*", -1);
const _hoisted_7 = {
  key: 0,
...
const _hoisted_15 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("option", {
  value: ""
}, null, -1);
...
const _hoisted_20 = {
  class: "col-height col-md-12 pull-right text-right"
};
const _hoisted_21 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("i", {
  class: "fa fa-search fa-btn-icon",
  "aria-hidden": "true"
}, null, -1);
const _hoisted_22 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("i", {
...
function SearchFormvue_type_template_id_30527109_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("div", SearchFormvue_type_template_id_30527109_hoisted_1, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", SearchFormvue_type_template_id_30527109_hoisted_2, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_3, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", _hoisted_4, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.datefroms_label), 1), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", {
    class: (0,shared_esm_bundler/* normalizeClass */.C4)(["input-group has-validation", {
      'has-error': $setup.v$.datefrom.$error
    }])
  }, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_5, [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_InputDate, {
    modelValue: $setup.localData.datefrom,
    "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => $setup.localData.datefrom = $event),
    id: "datefrom",
    ref: "datefrom"
  }, null, 8, ["modelValue"]), _hoisted_6])], 2), $setup.v$.datefrom.$error ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("span", _hoisted_7, (0,shared_esm_bundler/* toDisplayString */.v_)($setup.v$.datefrom.$errors[0].$message), 1)) : (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)("", true)]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_8, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", _hoisted_9, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.datetos_label), 1), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", {
    class: (0,shared_esm_bundler/* normalizeClass */.C4)(["input-group has-validation", {
      'has-error': $setup.v$.dateto.$error
    }])
  }, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_10, [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_InputDate, {
    modelValue: $setup.localData.dateto,
    "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => $setup.localData.dateto = $event),
    id: "dateto",
    ref: "dateto"
  }, null, 8, ["modelValue"]), _hoisted_11])], 2), $setup.v$.dateto.$error ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("span", _hoisted_12, (0,shared_esm_bundler/* toDisplayString */.v_)($setup.v$.dateto.$errors[0].$message), 1)) : (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)("", true)]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_13, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", _hoisted_14, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.trxstatuss_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("select", {
    ref: "trxstatuss",
    id: "trxstatuss",
    "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => $setup.localData.trxstatus = $event),
    class: "form-control input-md"
  }, [_hoisted_15, ((0,runtime_core_esm_bundler/* openBlock */.uX)(true), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, null, (0,runtime_core_esm_bundler/* renderList */.pI)($props.dataCategory.tkrxstatus, item => {
  ...
  }), 128))], 512), [[runtime_dom_esm_bundler/* vModelSelect */.u1, $setup.localData.trxstatus]])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_17, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.emails_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("input", {
    type: "text",
    "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => $setup.localData.owner = $event),
    class: "form-control input-md",
    maxlength: "100"
  }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.localData.owner]])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_18, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.quotables_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("input", {
    type: "text",
    "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => $setup.localData.quotable = $event),
    class: "form-control input-md",
    maxlength: "100"
  }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.localData.quotable]])])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_19, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_20, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("button", {
    onClick: _cache[5] || (_cache[5] = (...args) => $options.searchClick && $options.searchClick(...args)),
    class: "btn btn-dark btn-sm btn-ctrl"
  }, [_hoisted_21, (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.search_button), 1)]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("button", {
    onClick: _cache[6] || (_cache[6] = (...args) => $options.resetClick && $options.resetClick(...args)),
    class: "btn btn-dark btn-sm btn-ctrl",
    id: "resetbutton"
  }, [_hoisted_22, (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.reset_button), 1)])])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", _hoisted_23, [(0,runtime_core_esm_bundler/* createVNode */.bF)(_component_DataTable, {
    ref: "dataTable",
...
;// CONCATENATED MODULE: ./src/components/SearchForm.vue?vue&type=template&id=30527109
...
const tableSettings = {
  ...
  columns: [{
    ...
    type: "STRING",
    sorter: "quotable",
    label: "quotable_headerlabel"
  }, {
    name: "statusname",
    type: "STRING",
    sorter: "statusname",
    label: "statusname_headerlabel",
    css: "text-center"
  }, {
    name: "remark",
    type: "STRING",
  ...
  actions: [{
    ...
    render: function (record) {
      return record.refer && record.refer.trim().length > 0 ? {
        type: "a",
        action: "view",
...
;// CONCATENATED MODULE: ./src/components/SearchForm.vue?vue&type=style&index=0&id=30527109&lang=css
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.A)(SearchFormvue_type_script_lang_js, [['render',SearchFormvue_type_template_id_30527109_render]])

/* harmony default export */ var SearchForm = (__exports__);
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/EntryForm.vue?vue&type=template&id=029ef85e

const EntryFormvue_type_template_id_029ef85e_hoisted_1 = {
  key: 0,
  class: "modal-title"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_2 = {
  key: 0,
  class: "modal-title"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_3 = {
  key: 1,
  class: "modal-title"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_4 = {
  class: "row row-height"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_5 = {
  class: "col-height col-md-3"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_6 = {
  class: "col-height col-md-8"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_7 = {
  class: "row row-height"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_8 = {
  class: "col-height col-md-5"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_9 = {
  class: "col-height col-md-6"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_10 = {
  class: "row row-height"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_11 = {
  class: "col-height col-md-3"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_12 = {
  class: "row row-height"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_13 = {
  class: "col-height col-md-12"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_14 = {
  class: "row row-height"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_15 = {
  class: "col-height col-md-12",
  ref: "mailcontents"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_16 = ["innerHTML"];
const EntryFormvue_type_template_id_029ef85e_hoisted_17 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("em", {
  class: "fa fa-eye fa-btn-icon"
}, null, -1);
const EntryFormvue_type_template_id_029ef85e_hoisted_18 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("em", {
  class: "fa fa-send fa-btn-icon"
}, null, -1);
const EntryFormvue_type_template_id_029ef85e_hoisted_19 = {
  class: "btn btn-dark btn-sm",
  "data-dismiss": "modal"
};
const EntryFormvue_type_template_id_029ef85e_hoisted_20 = /*#__PURE__*/(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("em", {
  class: "fa fa-close fa-btn-icon"
}, null, -1);
function EntryFormvue_type_template_id_029ef85e_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createBlock */.Wv)(_component_DialogForm, {
    ...
    header: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [$options.isReferDialog ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("h4", EntryFormvue_type_template_id_029ef85e_hoisted_1, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.title_view), 1)) : ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)(runtime_core_esm_bundler/* Fragment */.FK, {
      key: 1
    }, [$options.insertMode ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("h4", EntryFormvue_type_template_id_029ef85e_hoisted_2, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.title_new), 1)) : (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)("", true), $options.updateMode ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("h4", EntryFormvue_type_template_id_029ef85e_hoisted_3, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.title_edit), 1)) : (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)("", true)], 64))]),
    default: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_4, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_5, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.transtime_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("input", {
      type: "text",
      "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => $setup.showData.transtime = $event),
      class: "form-control input-md",
      disabled: ""
    }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.showData.transtime]])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_6, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.quotable_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("input", {
      type: "text",
      "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => $setup.localData.quotable = $event),
      class: "form-control input-md",
      disabled: ""
    }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.localData.quotable]])])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_7, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_8, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.email_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("input", {
      type: "text",
      "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => $setup.localData.email = $event),
      class: "form-control input-md",
      disabled: ""
    }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.localData.email]])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_9, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.sender_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("input", {
      type: "text",
      "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => $setup.localData.sender = $event),
      class: "form-control input-md",
      disabled: ""
    }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.localData.sender]])])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_10, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_11, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.statusname_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("input", {
      type: "text",
      "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => $setup.localData.statusname = $event),
      class: "form-control input-md",
      disabled: ""
    }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.localData.statusname]])])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_12, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_13, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.remark_label), 1), (0,runtime_core_esm_bundler/* withDirectives */.bo)((0,runtime_core_esm_bundler/* createElementVNode */.Lk)("textarea", {
      "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => $setup.localData.remark = $event),
      class: "form-control input-md",
      cols: "100",
      rows: "10",
      readonly: ""
    }, null, 512), [[runtime_dom_esm_bundler/* vModelText */.Jo, $setup.localData.remark]])])]), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_14, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", EntryFormvue_type_template_id_029ef85e_hoisted_15, [(0,runtime_core_esm_bundler/* createElementVNode */.Lk)("label", null, (0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.contents_label), 1), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("div", {
      ref: "contents",
      class: "form-control input-md contents-mailing",
      innerHTML: $setup.localData.contents
    }, null, 8, EntryFormvue_type_template_id_029ef85e_hoisted_16)], 512)])]),
    footer: (0,runtime_core_esm_bundler/* withCtx */.k6)(() => [$options.hasRefer ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("button", {
      key: 0,
      ref: "referbutton",
      id: "referbutton",
      class: "btn btn-dark btn-sm pull-left",
      onClick: _cache[6] || (_cache[6] = (...args) => $options.referClick && $options.referClick(...args))
    }, [EntryFormvue_type_template_id_029ef85e_hoisted_17, (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.refer_button), 1)], 512)) : (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)("", true), $options.displayResend ? ((0,runtime_core_esm_bundler/* openBlock */.uX)(), (0,runtime_core_esm_bundler/* createElementBlock */.CE)("button", {
      key: 1,
      ref: "resendbutton",
      id: "resendbutton",
      class: "btn btn-dark btn-sm",
      onClick: _cache[7] || (_cache[7] = (...args) => $options.resendClick && $options.resendClick(...args))
    }, [EntryFormvue_type_template_id_029ef85e_hoisted_18, (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.resend_button), 1)], 512)) : (0,runtime_core_esm_bundler/* createCommentVNode */.Q3)("", true), (0,runtime_core_esm_bundler/* createElementVNode */.Lk)("button", EntryFormvue_type_template_id_029ef85e_hoisted_19, [EntryFormvue_type_template_id_029ef85e_hoisted_20, (0,runtime_core_esm_bundler/* createTextVNode */.eW)((0,shared_esm_bundler/* toDisplayString */.v_)($props.labels.cancel_button), 1)])]),
    _: 1
  }, 512);
}
;// CONCATENATED MODULE: ./src/components/EntryForm.vue?vue&type=template&id=029ef85e
...
const EntryFormvue_type_script_lang_js_APP_URL = "/api/sftq003";
...
/* harmony default export */ var EntryFormvue_type_script_lang_js = ({
  ...
  setup(props) {
    ...
    const showData = (0,reactivity_esm_bundler/* ref */.KR)({
      ...displayData
    });
    return {
      mode,
  ...
  computed: {
    ...
    isReferDialog() {
      return will_app/* Utilities */.FP.parseBoolean(this.$props.referDialog);
    },
    displayResend() {
      return will_app/* Utilities */.FP.parseBoolean(this.$props.canResend);
    }
  },
  mounted() {
  ...
  methods: {
    reset(newData, newMode) {
      ...
      if (this.localData.transtime && this.localData.transtime.trim().length > 0) {
        let date = will_app/* Utilities */.FP.parseDate(this.localData.transtime);
        if (date) transtime = will_app/* Utilities */.FP.formatDateTime(date);
      }
    ...
    resendRecord(dataRecord) {
      ...
      (0,will_app/* startWaiting */.eF)();
      jquery_default().ajax({
        url: (0,will_app/* getApiUrl */.e9)() + EntryFormvue_type_script_lang_js_APP_URL + "/resend",
        data: formdata.jsondata,
        headers: formdata.headers,
        type: "POST",
        dataType: "json",
    ...
    diableLinkedDocument() {
      jquery_default()("a", jquery_default()(this.$refs.mailcontents.$el)).attr("disabled", true).addClass("disabled").on("click", function (e) {
        e.preventDefault();
      });
    },
    resendClick() {
      console.log("click: resend");
      (0,will_app/* disableControls */.rv)(jquery_default()("#resendbutton"));
      this.startResendRecord();
    },
    referClick() {
      console.log("click: refer");
      (0,will_app/* disableControls */.rv)(jquery_default()("#referbutton"));
      if (this.hasRefer) {
...
;// CONCATENATED MODULE: ./src/components/EntryForm.vue?vue&type=style&index=0&id=029ef85e&lang=css
...
const EntryForm_exports_ = /*#__PURE__*/(0,exportHelper/* default */.A)(EntryFormvue_type_script_lang_js, [['render',EntryFormvue_type_template_id_029ef85e_render]])

/* harmony default export */ var EntryForm = (EntryForm_exports_);
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/AppVftq003.vue?vue&type=script&lang=js
...
const buildVersion = "20241028-094213";
/* harmony default export */ var AppVftq003vue_type_script_lang_js = ({
  components: {
  ...
  mounted() {
    ...
    this.$nextTick(async () => {
      ...
      (0,will_app/* startApplication */.xL)("vftq003", data => {
  ...
  methods: {
    ...
    resetDataCategories(lang) {
      ...
      if (tk_category) {
        tkrxstatus = tk_category.map(item => {
          return {
            id: item.typeid,
    ...
    dataSelected(item, action) {
      ...
      if ("edit" == action) {
        ...
        this.$refs.referForm.retrieveRecord({
          keyid: item.refer
        });
      }
    },
...
;// CONCATENATED MODULE: ./src/AppVftq003.vue?vue&type=script&lang=js
 
;// CONCATENATED MODULE: ./src/AppVftq003.vue




;
const AppVftq003_exports_ = /*#__PURE__*/(0,exportHelper/* default */.A)(AppVftq003vue_type_script_lang_js, [['render',render]])

/* harmony default export */ var AppVftq003 = (AppVftq003_exports_);
;// CONCATENATED MODULE: ./src/vftq003.js
...
(0,runtime_dom_esm_bundler/* createApp */.Ef)(AppVftq003).mount('#app');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkvftq003"] = self["webpackChunkvftq003"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [504], function() { return __webpack_require__(9631); })
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=index.f2bfecc6.js.map